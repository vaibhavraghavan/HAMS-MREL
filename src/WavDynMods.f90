...
!    Yingyi Liu
!---------------------------------------------------------------------------------------------
!        Data module for declaring input variables in HAMS-MREL (This is for variables for all the modules which are implemented in HAMS-MREL. These are hence mostly public.)
!---------------------------------------------------------------------------------------------					
!
        MODULE HAMS_mod
!
