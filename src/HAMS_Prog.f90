...
!    by 3D structures or multiples of them.
!  
!             Code for multi-body interactions: Vaibhav Raghavan, George Lavidas, Eva Loukogeorgaki           created on 2022.08.20
!             Code for the single body formulation: Yingyi Liu       created on  2012.08.07
! 
!  License:
! 
...
!  Brief introduction:
!
!    HAMS-MREL (Hydrodynamics Analysis of Marine Structures) can solve boundary value problems
!    in a three dimensional region using the boundary element method for both single body and multi-body problems. The problems this code 
...
!
!    The program as now written should read a mesh file/files generated by other softwares,
...
!
!    (1) Raghavan, V., Loukogeorgaki, E., Mantadakis, N., Metrikine, A. V., & Lavidas, G. (2024). 
!     HAMS‑MREL, a new open‑source multiple body solver for marine renewable energies: Model description,
!     application and validation. Renewable Energy, 237, 127857. DOI: https://doi.org/10.1016/j.renene.2024.121577
!    (2) Raghavan, V., Metrikine, A.V. & Lavidas, G. Theory and validation of the new features in BIEM solver HAMS-MREL. 
!     J. Ocean Eng. Mar. Energy 12, 53–71 (2026). DOI: https://doi.org/10.1007/s40722-025-00431-8
!    (3) Yingyi Liu, Hidetsugu Iwashita, Changhong Hu (2015). A calculation method for finite depth
...
!    (4) Yingyi Liu, Changhong Hu, Makoto Sueyoshi, Hidetsugu Iwashita, Masashi Kashiwagi (2016). 
...
!
!   ######### Version released in February, 2026 ####################
...
program HAMS_MREL
    ...
    print*
    write(*,'(80A)') '  HAMS-MREL is an open-source software for computing wave diffraction and radiation of 3D structures.'
    print*
    write(*,'(200A)') ' Please cite the following papers in your publications, reports, etc., when HAMS-MREL has been used in your work:'
    print*
    write(*,'(200A)') '  (1) Raghavan, V., Loukogeorgaki, E., Mantadakis, N., Metrikine, A. V., & Lavidas, G. (2024).'
    write(*,'(200A)') '      HAMS‑MREL, a new open‑source multiple body solver for marine renewable energies: Model description,'
    write(*,'(200A)') '      application and validation. Renewable Energy, 237, 127857. DOI: https://doi.org/10.1016/j.renene.2024.121577'
    print*
    write(*,'(200A)') '  (2) Raghavan, V., Metrikine, A.V. & Lavidas, G. Theory and validation of the new features in BIEM solver HAMS-MREL.'
    write(*,'(200A)') '      J. Ocean Eng. Mar. Energy 12, 53–71 (2026). DOI: https://doi.org/10.1007/s40722-025-00431-8'
    print*
