...
program HAMS_MREL
    ...
    if (NBODY == 1) then
        ...
        IF (IRSP.EQ.0) THEN
            ...
            ALLOCATE(MXPOT_MULTI_COMB(TNELEM,6*NBODY+1,NSYS),WVFQ(NPER),EXFC_MULTI(NBODY,NPER,NBETA,6), EXFC_MULTI_COMB(NBODY*6,NPER,NBETA),DSPL_MULTI_COMB(NBODY*6,NPER,NBETA),AMAS_MULTI(NPER,NBODY,6,6),BDMP_MULTI(NPER,NBODY,6,6),AMAS_MULTI_COMB(NPER,NBODY*6,NBODY*6),BDMP_MULTI_COMB(NPER,NBODY*6,NBODY*6))
        ...
        DO KK=1,NPER
            ...
            DO II=1,NBETA
                ...
                DO FILE_M=1,NBODY
                    ...
                    EXFC_MULTI_COMB(KK,II,6*(FILE_N-1)+1:6*(FILE_N-1)+6) = EXFC_MULTI(FILE_M,KK,II,:)
                ENDDO
