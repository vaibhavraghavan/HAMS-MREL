...
!$omp parallel do private(NTHREAD)
      DO IP=1, NSYS
           CALL ZGETRS( 'No transpose', NELEM, 6*NBODY, ATMAT(:,:,IP), NELEM, IPIV(:,IP), BRTMAT(:,:,IP), NELEM, INFO )             ! For reference - https://netlib.org/lapack/explore-html/d3/d01/group__complex16_g_ecomputational_ga3a5b88a7e8bf70591e521e86464e109d.html
      ENDDO
