...
!------------------------------------------------------------------------------- 
       ...
       SUBROUTINE SGLINTBD_TRI(IS,IEL,JEL,SIJ,DIJ,IRR)                                 ! This is for triangular elements
       IMPLICIT   NONE
...
!------------------------------------------------------------------------------- 
       ...
       SUBROUTINE SGLINTBD_QUAD(IS,IEL,JEL,SIJ,DIJ,IRR)                                            ! This is for quardilateral elements    
       IMPLICIT   NONE
...
!------------------------------------------------------------------------------- 
       ...
       SUBROUTINE SGLINTBD_TRI2(XF,JEL,RK,IRR)                                                     ! This is for triangular elements
       IMPLICIT   NONE
...
!------------------------------------------------------------------------------- 
       ...
       SUBROUTINE SGLINTBD_QUAD2(XF,JEL,RK,IRR)                                                  ! This is for quardilateral elements
       IMPLICIT   NONE
